...
def button_click(number):
    # e.delete(0, END) //To delete whatever is inside entry
    current = e.get()
    e.delete(0, END)
...
button_10 = Button(root, text="10", padx=35, pady=35, command=lambda: button_click(10))
button_add = Button(root, text="+", padx=40, pady=40, command=button_add)
button_multiply = Button(root, text="*", padx=40, pady=40, command=button_multiply)
button_subtract = Button(root, text="-", padx=40, pady=40, command=button_subtract)
button_divide = Button(root, text="/", padx=40, pady=40, command=button_divide)
button_clear = Button(root, text="C", padx=40, pady=40, command=button_clean)
button_equal = Button(root, text="=", padx = 35, pady=35, command=button_equal)
