...
# Number of Folders
number_of_folders = Entry(folder_num, width=35)
number_of_folders.pack()

folder_names = []

def button_click():
    number_of_folders.get()
    print(type(number_of_folders))

button_1 = Button(folder_num, text="Submit", width=35 , command=button_click).pack()
